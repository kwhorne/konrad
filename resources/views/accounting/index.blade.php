    ...
    <div class="min-h-screen bg-zinc-50 dark:bg-zinc-800">
        ...
        <flux:main class="bg-zinc-50 dark:bg-zinc-800">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <flux:text class="mt-1 text-base text-zinc-600 dark:text-zinc-400">
                        Oversikt over økonomi og regnskap
                    </flux:text>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <a href="{{ route('accounting.customer-ledger') }}" class="block">
                ...
                <!-- Supplier Payables -->
                <a href="{{ route('accounting.supplier-ledger') }}" class="block">
            ...
            <flux:card class="bg-white dark:bg-zinc-900 shadow-lg border border-zinc-200 dark:border-zinc-700">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                        <a href="{{ route('accounting.vouchers') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                        ...
                        <a href="{{ route('accounts.index') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                        ...
                        <a href="{{ route('accounting.customer-ledger') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                        ...
                        <a href="{{ route('accounting.supplier-ledger') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                        ...
                        <a href="{{ route('invoices.index') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                            <flux:icon.document-text class="w-6 h-6 text-green-500" />
                            <div>
                                <div class="font-medium text-zinc-900 dark:text-white">Fakturaer</div>
                                <div class="text-xs text-zinc-500">Utgående fakturaer</div>
                            </div>
                        </a>
                    </div>
                </div>
