...
<flux:sidebar sticky stashable class="bg-zinc-50 dark:bg-zinc-900 border-r rtl:border-r-0 rtl:border-l border-zinc-200 dark:border-zinc-700">
    ...
    <a href="{{ route('payroll.dashboard') }}" class="flex items-center gap-2 px-2 py-3">
        ...
        <div class="flex flex-col">
            ...
            <span class="text-xs text-zinc-500 dark:text-zinc-400">Lønn</span>
        </div>
    </a>
    ...
    <flux:navlist variant="outline">
        ...
        <flux:navlist.group expandable heading="Stamdata" class="grid">
            <flux:navlist.item icon="users" href="{{ route('payroll.employees') }}" :current="$current === 'employees'">
                Ansatte
            </flux:navlist.item>
        ...
        <flux:navlist.group expandable heading="Rapportering" class="grid">
            <flux:navlist.item icon="cloud-arrow-up" href="{{ route('payroll.a-melding') }}" :current="$current === 'a-melding'">
                A-melding
            </flux:navlist.item>
            <flux:navlist.item icon="chart-bar" href="{{ route('payroll.reports') }}" :current="$current === 'reports'">
                Rapporter
            </flux:navlist.item>
        </flux:navlist.group>
        ...
        <flux:navlist.item icon="cog-6-tooth" href="{{ route('payroll.settings') }}" :current="$current === 'settings'">
            Innstillinger
        </flux:navlist.item>
