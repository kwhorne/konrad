...
<head>
    ...
    <title>Glemt passord - Konrad Office</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 max-lg:hidden relative overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900">
            ...
            <div class="relative h-full flex flex-col justify-between p-12">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-white leading-tight">Tilbakestill passordet ditt</h2>
                    <p class="text-indigo-200/80 mt-4 leading-relaxed">Vi sender deg en lenke slik at du kan velge et nytt passord.</p>
                </div>
        ...
        <div class="flex-1 flex justify-center items-center p-8 bg-white dark:bg-zinc-900">
            <div class="w-full max-w-sm space-y-8">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Glemt passord?</h1>
                    <p class="text-zinc-500 dark:text-zinc-400 mt-1">Oppgi e-postadressen din, så sender vi en tilbakestillingslenke.</p>
                </div>

                @if (session('status'))
                    <div class="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/40 rounded-xl p-4">
