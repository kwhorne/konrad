...
<head>
    ...
    <title>Opprett konto - Konrad Office</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 max-lg:hidden relative overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900">
            ...
            <div class="relative h-full flex flex-col justify-between p-12">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-white leading-tight">Kom i gang med Konrad Office</h2>
                    <p class="text-indigo-200/80 mt-4 leading-relaxed">Et komplett forretningssystem for norske bedrifter.</p>
                </div>
        ...
        <div class="flex-1 flex justify-center items-center p-8 bg-white dark:bg-zinc-900">
            <div class="w-full max-w-sm space-y-8">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Opprett konto</h1>
                    <p class="text-zinc-500 dark:text-zinc-400 mt-1">Kom i gang med Konrad i dag</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <flux:button type="submit" variant="primary" class="w-full">Opprett konto</flux:button>
                </form>

                <p class="text-center text-sm text-zinc-500 dark:text-zinc-400">
                    Har du allerede en konto?
                    <a href="{{ route('login') }}" class="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">Logg inn</a>
                </p>
            </div>
        </div>
    </div>
