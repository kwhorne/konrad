        ...
        <div class="flex-1 flex justify-center items-center p-8">
            <div class="w-full max-w-sm space-y-8">
                ...
                <div class="text-center">
                    ...
                    <flux:subheading class="mt-2">Bekreft passordet ditt for å fortsette</flux:subheading>
                </div>
                ...
                <div class="p-4 bg-zinc-50 dark:bg-zinc-800 rounded-xl">
                    <div class="flex items-start gap-3">
                        ...
                        <flux:text class="text-sm text-zinc-600 dark:text-zinc-400">
                            Dette er et sikkert område. Vennligst bekreft passordet ditt for å fortsette.
                        </flux:text>
                    </div>
                </div>
