<x-layouts.economy title="Økonomi Dashboard">
    <div class="min-h-screen bg-zinc-50 dark:bg-zinc-800">
        <x-economy-sidebar current="economy-dashboard" />
        <x-app-header current="economy-dashboard" />
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <flux:text class="mt-1 text-base text-zinc-600 dark:text-zinc-400">
                        Oversikt over økonomi, regnskap og årsoppgjør
                    </flux:text>
                </div>
            </div>
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4">
                            ...
                            <a href="{{ route('economy.reports') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                                <flux:icon.chart-bar class="w-6 h-6 text-blue-500" />
                                <div>
                                    <div class="font-medium text-zinc-900 dark:text-white">Rapporter</div>
                                    <div class="text-xs text-zinc-500">Regnskapsrapporter</div>
                                </div>
                            </a>
                            <a href="{{ route('economy.vat-reports') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                                <flux:icon.document-chart-bar class="w-6 h-6 text-green-500" />
                                <div>
                                    <div class="font-medium text-zinc-900 dark:text-white">MVA</div>
                                    <div class="text-xs text-zinc-500">MVA-meldinger</div>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4">
                            @if(config('features.shareholders'))
                                <a href="{{ route('economy.shareholders') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                                    ...
                                    <div>
                                        <div class="font-medium text-zinc-900 dark:text-white">Aksjonærer</div>
                                        <div class="text-xs text-zinc-500">Aksjonærregister</div>
                                    </div>
                                </a>
                            @endif
                            <a href="{{ route('economy.tax') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                                <flux:icon.document-text class="w-6 h-6 text-amber-500" />
                                <div>
                                    <div class="font-medium text-zinc-900 dark:text-white">Skattemelding</div>
                                    <div class="text-xs text-zinc-500">RF-1028</div>
                                </div>
                            </a>
                            <a href="{{ route('economy.annual-accounts') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                                <flux:icon.chart-bar class="w-6 h-6 text-purple-500" />
                                <div>
                                    <div class="font-medium text-zinc-900 dark:text-white">Årsregnskap</div>
                                    <div class="text-xs text-zinc-500">Resultat og balanse</div>
                                </div>
                            </a>
                            <a href="{{ route('economy.altinn') }}" class="flex items-center gap-3 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                                <flux:icon.cloud-arrow-up class="w-6 h-6 text-teal-500" />
                                <div>
                                    <div class="font-medium text-zinc-900 dark:text-white">Altinn</div>
                                    <div class="text-xs text-zinc-500">Innsending</div>
                                </div>
                            </a>
                        </div>
                    </div>
