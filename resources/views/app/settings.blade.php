<x-layouts.app title="Innstillinger">
    <div class="min-h-screen bg-zinc-50 dark:bg-zinc-800">
        ...
        <flux:main class="bg-zinc-50 dark:bg-zinc-800">
            ...
            @php
                $canManageCompany = app('current.company') && auth()->user()->canManage(app('current.company'));
            @endphp

            <flux:tab.group>
                <flux:tabs>
                    <flux:tab name="account" icon="user">Min konto</flux:tab>
                    @if($canManageCompany)
                ...
                <!-- Account Tab Panel -->
                <flux:tab.panel name="account" class="pt-6">
                                ...
                                <flux:card class="bg-white dark:bg-zinc-900 shadow-sm border border-zinc-200 dark:border-zinc-700">
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <flux:checkbox id="marketing_emails" name="marketing_emails" :checked="auth()->user()->marketing_emails" />
                                        </div>
                                    </div>
                                </flux:card>
                            </section>
