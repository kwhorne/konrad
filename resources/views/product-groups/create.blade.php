<x-layouts.app title="Ny varegruppe">
                ...
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <flux:text class="mt-1 text-zinc-600 dark:text-zinc-400">
                            Opprett en ny varegruppe
                        </flux:text>
                    </div>
                </div>

                <flux:card class="bg-white dark:bg-zinc-900 shadow-lg border border-zinc-200 dark:border-zinc-700">
                    <form action="{{ route('product-groups.store') }}" method="POST" class="p-6 space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <flux:field>
                                ...
                                <flux:input id="code" name="code" type="text" value="{{ old('code') }}" required placeholder="F.eks. TJENESTER" />
                                @error('code')
                                    <flux:error>{{ $message }}</flux:error>
                                @enderror
                            </flux:field>
