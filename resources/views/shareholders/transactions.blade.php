<x-layouts.app title="Aksjetransaksjoner">
        ...
        <flux:main class="bg-zinc-50 dark:bg-zinc-800">
            <div class="flex items-center gap-4 mb-8">
                <div class="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center shadow-lg">
                    <flux:icon.arrows-right-left class="w-7 h-7 text-white" />
                </div>
                <div>
                    ...
                    <flux:text class="mt-1 text-base text-zinc-600 dark:text-zinc-400">
                        Historikk over emisjoner, overdragelser og innløsninger
                    </flux:text>
                </div>
            </div>
            ...
            <livewire:share-transaction-manager />
        </flux:main>
    </div>
</x-layouts.app>
