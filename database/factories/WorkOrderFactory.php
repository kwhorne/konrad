...
class WorkOrderFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'work_order_type_id' => WorkOrderType::inRandomOrder()->first()?->id,
            'work_order_status_id' => WorkOrderStatus::inRandomOrder()->first()?->id,
            'work_order_priority_id' => WorkOrderPriority::inRandomOrder()->first()?->id,
            'assigned_to' => User::first()?->id ?? User::factory(),
